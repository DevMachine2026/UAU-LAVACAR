  ...
  return (
    <Screen>
      <View className="gap-5">
        <Text className="text-3xl font-bold text-uau-black">Minhas cobranças</Text>
        ...
        {currentQuery.data ? (
          <Card>
            <View className="gap-3">
              <Text className="text-xl font-bold text-uau-black">Cobrança atual</Text>
            ...
            <View className="gap-4">
              <View className="gap-2">
                ...
                <Text className="text-sm leading-5 text-uau-gray">
                  Quando houver cobrança em aberto, ela aparecerá aqui.
                </Text>
              </View>
              ...
              <Card key={getString(record, ["id"], String(index))}>
                <View className="flex-row justify-between gap-3">
                  <View className="flex-1">
                    <Text className="font-semibold text-uau-black">{getString(record, ["status"], "Cobrança")}</Text>
